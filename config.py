...
class Settings(BaseSettings):
    ...
    # CORS
    CORS_ORIGINS: str = os.getenv("CORS_ORIGINS", "http://localhost:5173,http://localhost:3000,https://neuroflow-production-845c.up.railway.app,https://neuro-flow-psi.vercel.app")
    ...
    DISCORD_REDIRECT_URI: str = os.getenv("DISCORD_REDIRECT_URI", "https://neuroflow-production-845c.up.railway.app/discord/callback")
    DISCORD_BOT_TOKEN: Optional[str] = os.getenv("DISCORD_BOT_TOKEN")

    # Google OAuth2 Settings
    GOOGLE_CLIENT_ID: Optional[str] = os.getenv("GOOGLE_CLIENT_ID")
    GOOGLE_CLIENT_SECRET: Optional[str] = os.getenv("GOOGLE_CLIENT_SECRET")
    GOOGLE_REDIRECT_URI: str = os.getenv("GOOGLE_REDIRECT_URI", "https://neuroflow-production-845c.up.railway.app/google/callback")
